...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=21809690&assignment_repo_type=AssignmentRepo)
...
- **Widoki (3–4):**
  ...
  4. _(Opcjonalnie)_ **Ustawienia** (np. preferencje, tryb offline).
...
Zadanie było dla mnie za trudne i przez niewystraczającą ilość czasu nie zdążyłem wykonać projektu, jeśli będzie możliwość jeszcze wysłania, wykonam je w późniejszym terminie
